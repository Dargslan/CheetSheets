# Defender + ASR Audit Cheat Sheet

> Audit Microsoft Defender end-to-end: real-time protection, ASR rules with friendly names, exclusions and tamper.

---

## Quick Reference

This cheat sheet provides a concise, printable reference for **Defender + ASR Audit Cheat Sheet**.
...
| Resource | Link |
|---|---|
| **Download PDF** | [https://dargslan.com/cheat-sheets/windows-defender-asr-audit-2026](https://dargslan.com/cheat-sheets/windows-defender-asr-audit-2026) |
