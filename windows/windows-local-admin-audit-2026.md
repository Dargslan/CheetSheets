# Local Admin Audit Cheat Sheet

> Audit the local Administrators group, every local user, Guest state and orphan-SID admins.

---

## Quick Reference

This cheat sheet provides a concise, printable reference for **Local Admin Audit Cheat Sheet**.
...
| Resource | Link |
|---|---|
| **Download PDF** | [https://dargslan.com/cheat-sheets/windows-local-admin-audit-2026](https://dargslan.com/cheat-sheets/windows-local-admin-audit-2026) |
