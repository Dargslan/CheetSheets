# IIS + TLS Audit Cheat Sheet

> Audit IIS bindings, SChannel TLS state and app pool identities from PowerShell.

---

## Quick Reference

This cheat sheet provides a concise, printable reference for **IIS + TLS Audit Cheat Sheet**.
...
| Resource | Link |
|---|---|
| **Download PDF** | [https://dargslan.com/cheat-sheets/iis-tls-security-audit-2026](https://dargslan.com/cheat-sheets/iis-tls-security-audit-2026) |
