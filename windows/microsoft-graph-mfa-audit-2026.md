# Graph MFA Audit Cheat Sheet

> Find users with only password, only SMS, or MFA registered but not enforced.

---

## Quick Reference

This cheat sheet provides a concise, printable reference for **Graph MFA Audit Cheat Sheet**.
...
| Resource | Link |
|---|---|
| **Download PDF** | [https://dargslan.com/cheat-sheets/microsoft-graph-mfa-audit-2026](https://dargslan.com/cheat-sheets/microsoft-graph-mfa-audit-2026) |
