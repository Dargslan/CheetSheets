...
> Quick reference for Kubernetes pod scheduling, affinity rules, taints, tolerations, resource management, and HPA configuration.

---

## Quick Reference

This cheat sheet provides a concise, printable reference for **Kubernetes Scheduling Cheat Sheet**.
...
| Resource | Link |
|---|---|
| **Download PDF** | [https://dargslan.com/cheat-sheets/kubernetes-scheduling-cheat-sheet](https://dargslan.com/cheat-sheets/kubernetes-scheduling-cheat-sheet) |
