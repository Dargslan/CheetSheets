...
> Linux command reference for Shell Scripting: alias, basename, dirname, echo, env, export, expr, getopts, history, printenv. Includes syntax, options, practical examples with output, and pro tips. 17 pages, 10 commands.

---

## Quick Reference

This cheat sheet provides a concise, printable reference for **Linux Commands: Shell Scripting (Part 1)**.
...
| Resource | Link |
|---|---|
| **Download PDF** | [https://dargslan.com/cheat-sheets/linux-commands-shell-scripting-part-1-cheatsheet](https://dargslan.com/cheat-sheets/linux-commands-shell-scripting-part-1-cheatsheet) |
