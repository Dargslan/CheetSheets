...
> Locale settings, available locales, encoding detection, and language environment configuration.

---

## Quick Reference

This cheat sheet provides a concise, printable reference for **Locale & Encoding Configuration**.
...
| Resource | Link |
|---|---|
| **Download PDF** | [https://dargslan.com/cheat-sheets/locale-encoding-config](https://dargslan.com/cheat-sheets/locale-encoding-config) |
