...
> Hostname management, DNS resolution, reverse lookup, and resolver configuration commands.

---

## Quick Reference

This cheat sheet provides a concise, printable reference for **Hostname & DNS Resolution**.
...
| Resource | Link |
|---|---|
| **Download PDF** | [https://dargslan.com/cheat-sheets/hostname-dns-resolution](https://dargslan.com/cheat-sheets/hostname-dns-resolution) |
